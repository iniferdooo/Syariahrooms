...
<body class="bg-[url('../../assets/bg2.jpg')] bg-cover w-full">
<section class="min-h-screen flex items-center justify-center">
  <div class="backdrop-blur-2xl flex flex-col sm:flex-row rounded-2xl shadow-lg max-w-3xl p-5">
    ...
    <div class="w-full sm:w-1/2 pl-7 pr-7">
      ...
      <p class="text-[#63B3A8] mt-1 font-serif">Sign up your account</p>
      <form class="flex flex-col gap-2 mt-4" action="register" method="POST">
        <div class="flex flex-col sm:flex-row w-[330px] bg-[#696969] rounded-lg gap-2">
          <input class="bg-[#696969] p-2 ml-6 border-l-2 border-l-[#696969] rounded-lg text-white font-serif sm:w-[304px]" type="email" name="email" id="email" placeholder="Email" required>
        ...
        <div class="flex flex-col sm:flex-row w-[330px] bg-[#696969] rounded-lg gap-2">
          <input class="bg-[#696969] p-2 ml-6 border-l-2 border-l-[#696969] rounded-lg text-white font-serif sm:w-[304px]" type="text" name="gender" id="gender" placeholder="Gender">
        ...
        <div class="flex flex-col sm:flex-row w-[330px] bg-[#696969] rounded-lg gap-2">
          <input class="bg-[#696969] p-2 ml-6 border-l-2 border-l-[#696969] rounded-lg text-white font-serif sm:w-[304px]" type="text" name="address" id="address" placeholder="Your address">
        ...
        <div class="flex flex-col sm:flex-row w-[330px] bg-[#696969] rounded-lg gap-2">
          <input class="bg-[#696969] p-2 ml-6 border-l-2 border-l-[#696969] rounded-lg text-white font-serif sm:w-[304px]" type="password" name="password" id="password" placeholder="Password" required>
        ...
        <div class="flex flex-col sm:flex-row w-[330px] bg-[#696969] rounded-lg gap-2">
          <input class="bg-[#696969] p-2 ml-6 border-l-2 border-l-[#696969] rounded-lg text-white font-serif sm:w-[304px]" type="password" name="password-confirmation" id="password-confirmation" placeholder="Re-enter password" required>
          <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-key absolute translate-x-2 translate-y-3" viewBox="0 0 16 16">
            <path d="M0 8a4 4 0 0 1 7.465-2H14a.5.5 0 0 1 .354.146l1.5 1.5a.5.5 0 0 1 0 .708l-1.5 1.5a.5.5 0 0 1-.708 0L13 9.207l-.646.647a.5.5 0 0 1-.708 0L11 9.207l-.646.647a.5.5 0 0 1-.708 0L9 9.207l-.646.647A.5.5 0 0 1 8 10h-.535A4 4 0 0 1 0 8m4-3a3 3 0 1 0 2.712 4.285A.5.5 0 0 1 7.163 9h.63l.853-.854a.5.5 0 0 1 .708 0l.646.647.646-.647a.5.5 0 0 1 .708 0l.646.647.646-.647a.5.5 0 0 1 .708 0l.646.647.793-.793-1-1h-6.63a.5.5 0 0 1-.451-.285A3 3 0 0 0 4 5"/>
            <path d="M4 8a1 1 0 1 1-2 0 1 1 0 0 1 2 0"/>
          </svg>
