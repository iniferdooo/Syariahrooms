      ...
      <div class="w-full sm:w-1/2 pl-7 pr-7">
        ...
        <form class="flex flex-col gap-2 mt-4" action="registeruser" method="POST">
          ...
          <div class="flex flex-col sm:flex-row w-[330px] bg-[#696969] rounded-lg gap-2">
            <input
              class="bg-[#696969] p-2 ml-6 border-l-2 border-l-[#696969] rounded-lg text-white font-serif sm:w-[304px]"
          ...
          <div id="checkPassword" class="font-bold text-[#B22222] mt-3 font-serif">Great job! Your password is strong
          </div>
        ...
        <p class="font-sans text-center"><span class="text-gray-950">Terms & Conditions</span> and <span
            class="text-gray-950">Privacy Policy</span></p>
